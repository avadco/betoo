/**
 * avad browse server — persistent Chromium daemon
 *
 * Architecture:
 ...
 *
 * State:
 *   State file: <project-root>/..avad/avad:browse.json (set via BROWSE_STATE_FILE env)
 *   Log files:  <project-root>/..avad/browse-{console,network,dialog}.log
...
function generateHelpText(): string {
  ...
  const lines = ['avad browse — headless browser for AI agents', '', 'Commands:'];
