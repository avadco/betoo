...
version: 1.0.0
description: |
  MANUAL TRIGGER ONLY: invoke only when user types /avad:setup-browser-cookies.
...
If the user specifies a domain directly (e.g., `/avad:setup-browser-cookies github.com`), skip the UI:
