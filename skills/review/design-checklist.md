...
**Trigger:** Only run this checklist if the diff touches frontend files. Use `avad-diff-scope` to detect:
...
- **[LOW]** — Requires understanding visual intent. Present as: "Possible issue — verify visually or run /avad:design-review."
...
**LOW confidence items** → present as "Possible: [description]. Verify visually or run /avad:design-review." Never AUTO-FIX.
...
- [file:line] Possible issue — verify with /avad:design-review
```
