...
- Options presented with only human-team effort estimates — should show both human and CC+avad time
...
This heuristic is referenced by both `/avad:review` and `/avad:ship`. It determines whether
